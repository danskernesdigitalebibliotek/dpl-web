...
`)}},Xt=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],br=o=>{let[e,t,r]=Xt(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},qe=({property:o,value:e})=>`${o}: ${e};`;var wr=function(o,e,t,r){function i(n){return n instanceof t?n:new t(function(s){s(n)})}return new(t||(t=Promise))(function(n,s){function c(l){try{d(r.next(l))}catch(h){s(h)}}function a(l){try{d(r.throw(l))}catch(h){s(h)}}function d(l){l.done?n(l.value):i(l.value).then(c,a)}d((r=r.apply(o,e||[])).next())})},Xe=o=>wr(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),Kt=({node:o,onClose:e})=>{if(!o)return null;let t=new ve(o),r=i=>i.stopPropagation();return b`
    <div
...
`;var Ke=({node:o,selected:e=!1,computedThickness:t,onClick:r})=>{let{x:i,y:n,width:s,height:c}=o.absoluteBoundingBox,a="cornerRadius"in o&&o.cornerRadius?{topLeft:o.cornerRadius,topRight:o.cornerRadius,bottomRight:o.cornerRadius,bottomLeft:o.cornerRadius}:"rectangleCornerRadii"in o&&o.rectangleCornerRadii?{topLeft:o.rectangleCornerRadii[0],topRight:o.rectangleCornerRadii[1],bottomRight:o.rectangleCornerRadii[2],bottomLeft:o.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},d=t/2,l=(g,w)=>`M${g},${w}`,h=(g,w)=>`L${g},${w}`,u=(g,w,S)=>`A${g},${g} 0 0 1 ${w},${S}`,f=[l(a.topLeft+d,d),h(s-a.topRight,d),u(a.topRight-d,s-d,a.topRight),h(s-d,c-a.bottomRight),u(a.bottomRight-d,s-a.bottomRight,c-d),h(a.bottomLeft,c-d),u(a.bottomLeft-d,d,c-a.bottomLeft),h(d,a.topLeft),u(a.topLeft-d,a.topLeft,d),"Z"].join(" ");return E`
    <path
      class="guide"
      d=${f}
      shape-rendering="geometricPrecision"
  ...
  >
    ...
    >
      Edited ${oo(t)}
        ...
        "
          >
            ${Object.entries(this.__images).map(([f,g])=>{var w;let S=C(this,n,"f").call(this,f);if(!S||!("absoluteBoundingBox"in S)||!(!((w=C(this,t,"f"))===null||w===void 0)&&w[S.id]))return null;let x=C(this,t,"f")[S.id];return b`
                <img
...
`,bo=M`
  ...
  z-index: 1;
`});function Br(o,e){let t=new URL(o);t.hostname=t.hostname.replace(/^www\./,"embed."),t.searchParams.delete("embed_origin"),t.searchParams.set("embed-host",e);for(let[r,i]of t.searchParams)t.searchParams.delete(r),t.searchParams.set(r.replace(/_/g,"-"),i);return t.href}var it,wo,xo,_o=at(()=>{lt(),it=/https:\/\/[\w.-]+\.?figma.com\/([\w-]+)\/([0-9a-zA-Z]{22,128})(?:\/.*)?$/,wo=o=>it.test(o),xo=({config:o})=>{let e=G(()=>wo(o.url)?{url:Br(o.url,o.embedHost||location.hostname),allowFullscreen:o.allowFullscreen}:(console.warn(`[storybook-addon-designs] The URL you specified is not valid Figma URL.
...
`,qr=({config:o})=>p("div",{css:Xr},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Xr=M`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
