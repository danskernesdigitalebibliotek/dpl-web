...
import { MaterialSliderItem } from "../../Library/material-slider/MaterialSlider";
...
const relatedWorks: MaterialSliderItem[] = [
  {
    title: "Den fantastiske fortælling",
    href: "/",
    coverSrc: "images/book_cover_1_medium.jpg",
    subtitle: "Del 1 i serien Eventyrkrøniken",
  },
  {
    title: "Mysteriet på Møllegården : en fortælling fra landet",
    href: "/",
    coverSrc: "images/book_cover_2_medium.jpg",
    subtitle: "Del 1 i serien Møllegården",
  },
  {
    title: "Vinterbørn",
    href: "/",
    coverSrc: "images/book_cover_3_medium.jpg",
    subtitle: "Bind 1 i serien Årstiderne",
  },
...
export default {
  ...
  args: {
    ...
    authorHref: "/",
    coverSrcs: [
      "images/book_cover_1_medium.jpg",
      "images/book_cover_2_medium.jpg",
      "images/book_cover_3_medium.jpg",
    ],
    members,
...
WithOneCover.args = {
  coverSrcs: ["images/book_cover_1_medium.jpg"],
};
