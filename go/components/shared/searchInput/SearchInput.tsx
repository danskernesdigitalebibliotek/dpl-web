  ...
  return (
    <div className="relative w-full">
      <input
        ref={inputRef}
        className={cn(
          `focus-visible bg-background-overlay text-typo-subtitle-lg border-border
          placeholder:text-muted-foreground rounded-base flex h-[50px] w-full border px-5
          transition-colors disabled:cursor-not-allowed disabled:opacity-50 lg:h-20`,
          className
        )}
        value={currentQuery}
