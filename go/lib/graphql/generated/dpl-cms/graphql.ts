...
export type GetDplCmsPrivateConfigurationQuery = { go: { cacheTags: string[] } } & { goConfiguration: { private: { unilogin: { clientSecret: string | null, pubHubRetailerKeyCode: string | null } | null } | null } | null };
