...
function getEnvs() {
  return {
    ...
    WEDOBOOKS_API_BASE_URL: process.env.WEDOBOOKS_API_BASE_URL,
    WEDOBOOKS_API_KEY: process.env.WEDOBOOKS_API_KEY,
...
const EnvServerSchema = z.object({
  ...
  WEDOBOOKS_API_BASE_URL: z.string().refine(validateUrl).optional(),
  WEDOBOOKS_API_KEY: z.string().optional(),
