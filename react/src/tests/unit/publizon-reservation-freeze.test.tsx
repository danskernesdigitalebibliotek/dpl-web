...
// Publizon answers the whole loan decision with one status code.
const LOANABLE = ContentLoanStatusEnum.NUMBER_4;
const RESERVABLE = ContentLoanStatusEnum.NUMBER_5;
  ...
  describe("making a reservation", () => {
    it("Refuses a reservation Publizon would have taken, and says why", () => {
      ...
      expect(renderState()).toMatchObject({
        canBeReserved: false,
        publizonReservationsClosed: true
      });
    });
    ...
    it("Keeps lending an available material during the freeze", () => {
      ...
      // has been shut down rather than frozen. publizonReservationsClosed stays false
