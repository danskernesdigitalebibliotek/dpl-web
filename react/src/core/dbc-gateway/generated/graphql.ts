...
export type GetMaterialGoVipQueryVariables = Exact<{
  wid: Scalars["String"]["input"];
}>;

export type GetMaterialGoVipQuery = {
  __typename?: "Query";
  work?: {
    __typename?: "Work";
    workId: string;
...
export type SearchWithPaginationGoVipQueryVariables = Exact<{
  q: SearchQueryInput;
  offset: Scalars["Int"]["input"];
  limit: Scalars["PaginationLimitScalar"]["input"];
  filters?: InputMaybe<SearchFiltersInput>;
...
export type SearchWithPaginationGoVipQuery = {
  __typename?: "Query";
  search: {
    __typename?: "SearchResponse";
    hitcount: number;
...
export const GetMaterialGoVipDocument = `
    query getMaterialGoVip($wid: String!) {
  work(id: $wid) {
    ...WorkMedium
  }
}
...
export const useGetMaterialGoVipQuery = <
  TData = GetMaterialGoVipQuery,
  TError = unknown
>(
  variables: GetMaterialGoVipQueryVariables,
  options?: UseQueryOptions<GetMaterialGoVipQuery, TError, TData>
) => {
  return useQuery<GetMaterialGoVipQuery, TError, TData>(
    ["getMaterialGoVip", variables],
    fetcher<GetMaterialGoVipQuery, GetMaterialGoVipQueryVariables>(
      GetMaterialGoVipDocument,
      variables
    ),
    options
  );
...
export const SearchWithPaginationGoVipDocument = `
    query searchWithPaginationGoVip($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimitScalar!, $filters: SearchFiltersInput) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: $offset, limit: $limit) {
      ...WorkSmall
...
export const useSearchWithPaginationGoVipQuery = <
  TData = SearchWithPaginationGoVipQuery,
  TError = unknown
>(
  variables: SearchWithPaginationGoVipQueryVariables,
  options?: UseQueryOptions<SearchWithPaginationGoVipQuery, TError, TData>
) => {
  return useQuery<SearchWithPaginationGoVipQuery, TError, TData>(
    ["searchWithPaginationGoVip", variables],
    fetcher<
      SearchWithPaginationGoVipQuery,
      SearchWithPaginationGoVipQueryVariables
    >(SearchWithPaginationGoVipDocument, variables),
    options
  );
};
...
export const operationNames = {
  Query: {
    ...
    getMaterialGoVip: "getMaterialGoVip" as const,
    ...
    searchWithPaginationGoVip: "searchWithPaginationGoVip" as const,
