...
export type ComplexSearchFacetsInput = {
  facetLimit: number;
  facets?: Array<ComplexSearchFacetsEnum> | null | undefined;
};

/** Search Filters */
export type ComplexSearchFiltersInput = {
  /** Id of agency. */
  agencyId?: Array<string> | null | undefined;
  /** Name of the branch. */
  branch?: Array<string> | null | undefined;
  /** BranchId.  */
  branchId?: Array<string> | null | undefined;
  /** The circulationrule of the item */
  circulationRule?: Array<string> | null | undefined;
  /** Overall location in library (eg. Voksne). */
  department?: Array<string> | null | undefined;
  /** Date of first accession */
  firstAccessionDate?: string | null | undefined;
  /** The floatgroup of the item */
  floatGroup?: Array<string> | null | undefined;
  /** Id of publishing issue. */
  issueId?: Array<string> | null | undefined;
  /** Local id of the item. */
  itemId?: Array<string> | null | undefined;
  /** Where is the book physically located  (eg. skønlitteratur). */
  location?: Array<string> | null | undefined;
  /** The section which the item belongs to */
  section?: Array<string> | null | undefined;
  /** Onloan or OnShelf. */
  status?: Array<CsHoldingsStatusEnum> | null | undefined;
  /** More specific location (eg. Fantasy). */
  sublocation?: Array<string> | null | undefined;
  /** Boolean to denote whether to include or exclude online holdingsitems */
  useOnlineHoldings?: boolean | null | undefined;
};
...
export type CopyRequestInput = {
  authorOfComponent?: string | null | undefined;
  issueOfComponent?: string | null | undefined;
  openURL?: string | null | undefined;
  pagesOfComponent?: string | null | undefined;
  pickUpAgencySubdivision?: string | null | undefined;
  /** The pid of an article or periodica */
  pid: string;
  publicationDateOfComponent?: string | null | undefined;
  publicationTitle?: string | null | undefined;
  publicationYearOfComponent?: string | null | undefined;
  titleOfComponent?: string | null | undefined;
  userInterestDate?: string | null | undefined;
  userMail?: string | null | undefined;
  userName?: string | null | undefined;
  volumeOfComponent?: string | null | undefined;
};
...
export type SearchFiltersInput = {
  ...
  age?: Array<string> | null | undefined;
  ageRange?: Array<string> | null | undefined;
  branchId?: Array<string> | null | undefined;
  canAlwaysBeLoaned?: Array<string> | null | undefined;
  childrenOrAdults?: Array<string> | null | undefined;
  creators?: Array<string> | null | undefined;
  department?: Array<string> | null | undefined;
  dk5?: Array<string> | null | undefined;
  fictionNonfiction?: Array<string> | null | undefined;
  fictionalCharacters?: Array<string> | null | undefined;
  gamePlatform?: Array<string> | null | undefined;
  generalAudience?: Array<string> | null | undefined;
  genreAndForm?: Array<string> | null | undefined;
  letRange?: Array<string> | null | undefined;
  libraryRecommendation?: Array<string> | null | undefined;
  lixRange?: Array<string> | null | undefined;
  location?: Array<string> | null | undefined;
  mainLanguages?: Array<string> | null | undefined;
  materialTypesGeneral?: Array<string> | null | undefined;
  materialTypesSpecific?: Array<string> | null | undefined;
  status?: Array<HoldingsStatusEnum> | null | undefined;
  subjects?: Array<string> | null | undefined;
  sublocation?: Array<string> | null | undefined;
  workTypes?: Array<string> | null | undefined;
  year?: Array<string> | null | undefined;
};
...
export type SubmitOrderInput = {
  ...
  authorOfComponent?: string | null | undefined;
  exactEdition?: boolean | null | undefined;
  /** expires is required to be iso 8601 dateTime eg. "2024-03-15T12:24:32Z" */
  expires?: string | null | undefined;
  key?: string | null | undefined;
  orderType?: OrderTypeEnum | null | undefined;
...
export type SubmitOrderUserParametersInput = {
  ...
  userMail?: string | null | undefined;
  userName?: string | null | undefined;
  userTelephone?: string | null | undefined;
};
...
export type ComplexFacetSearchQueryVariables = Exact<{
  cql: string;
  facets?: ComplexSearchFacetsInput | null | undefined;
  filters?: ComplexSearchFiltersInput | null | undefined;
}>;


export type ComplexFacetSearchQuery = { complexSearch: { facets: Array<{ name: string | null, values: Array<{ key: string, score: number }> | null }> | null } };
...
export type ComplexSuggestQuery = { complexSuggest: { result: Array<{ type: string, term: string, traceId: string }> } };
...
export type GetSmallWorkQuery = { work: { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
      | { __typename: 'Corporation', display: string }
      | { __typename: 'Person', display: string }
    >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
            | { display: string }
            | { display: string }
            | { display: string }
            | { display: string }
            ...
            | { display: string }
            | { display: string }
          > }, titles: { main: Array<string>, original: Array<string> | null }, fictionNonfiction: { display: string, code: FictionNonfictionCodeEnum } | null, materialTypes: Array<{ materialTypeSpecific: { display: string } }>, creators: Array<
          | { __typename: 'Corporation', display: string }
          | { __typename: 'Person', display: string }
        >, identifiers: Array<{ type: IdentifierTypeEnum, value: string }>, contributors: Array<
          | { display: string, roles: Array<{ function: { singular: string } }> }
          | { display: string, roles: Array<{ function: { singular: string } }> }
        >, contents: Array<{ heading: string, type: ContentsEntityEnum, raw: string | null, entries: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, creators: { persons: Array<{ display: string, firstName: string | null, lastName: string | null, attributeToName: string | null }> | null, corporations: Array<{ display: string, main: string | null }> | null } | null, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string } }> | null }> | null }> | null }> | null, edition: { summary: string, publicationYear: { display: string } | null } | null, dateFirstEdition: { display: string, year: number | null } | null, audience: { generalAudience: Array<string>, ages: Array<{ display: string }>, childrenOrAdults: Array<{ display: string, code: ChildOrAdultCodeEnum }> } | null, notes: Array<{ display: Array<string> }>, languages: { notes: Array<string> | null, main: Array<{ display: string, iso639Set1: string }> | null } | null, physicalDescription: { summaryFull: string | null, numberOfPages: number | null } | null, hostPublication: { summary: string } | null, accessTypes: Array<{ code: AccessTypeCodeEnum }>, access: Array<
          | { __typename: 'AccessUrl', origin: string, url: string, loginRequired: boolean, status: LinkStatusEnum }
          ...
          | { __typename: 'Publizon' }
        >, shelfmark: { postfix: string | null, shelfmark: string } | null, workYear: { year: number | null } | null, catalogueCodes: { nationalBibliography: Array<string>, otherCatalogues: Array<string> } }>, latest: { pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
            | { display: string }
            | { display: string }
            | { display: string }
            | { display: string }
        ...
        >, contents: Array<{ heading: string, type: ContentsEntityEnum, raw: string | null, entries: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, creators: { persons: Array<{ display: string, firstName: string | null, lastName: string | null, attributeToName: string | null }> | null, corporations: Array<{ display: string, main: string | null }> | null } | null, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string } }> | null }> | null }> | null }> | null, edition: { summary: string, publicationYear: { display: string } | null } | null, dateFirstEdition: { display: string, year: number | null } | null, audience: { generalAudience: Array<string>, ages: Array<{ display: string }>, childrenOrAdults: Array<{ display: string, code: ChildOrAdultCodeEnum }> } | null, notes: Array<{ display: Array<string> }>, languages: { notes: Array<string> | null, main: Array<{ display: string, iso639Set1: string }> | null } | null, physicalDescription: { summaryFull: string | null, numberOfPages: number | null } | null, hostPublication: { summary: string } | null, accessTypes: Array<{ code: AccessTypeCodeEnum }>, access: Array<
          ...
          | { __typename: 'InterLibraryLoan', loanIsPossible: boolean }
          | { __typename: 'Publizon' }
        >, shelfmark: { postfix: string | null, shelfmark: string } | null, workYear: { year: number | null } | null, catalogueCodes: { nationalBibliography: Array<string>, otherCatalogues: Array<string> } }, bestRepresentation: { pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
            | { display: string }
            | { display: string }
            | { display: string }
            | { display: string }
        ...
        >, contents: Array<{ heading: string, type: ContentsEntityEnum, raw: string | null, entries: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, creators: { persons: Array<{ display: string, firstName: string | null, lastName: string | null, attributeToName: string | null }> | null, corporations: Array<{ display: string, main: string | null }> | null } | null, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string } }> | null }> | null }> | null }> | null, edition: { summary: string, publicationYear: { display: string } | null } | null, dateFirstEdition: { display: string, year: number | null } | null, audience: { generalAudience: Array<string>, ages: Array<{ display: string }>, childrenOrAdults: Array<{ display: string, code: ChildOrAdultCodeEnum }> } | null, notes: Array<{ display: Array<string> }>, languages: { notes: Array<string> | null, main: Array<{ display: string, iso639Set1: string }> | null } | null, physicalDescription: { summaryFull: string | null, numberOfPages: number | null } | null, hostPublication: { summary: string } | null, accessTypes: Array<{ code: AccessTypeCodeEnum }>, access: Array<
          ...
          | { __typename: 'InterLibraryLoan', loanIsPossible: boolean }
          | { __typename: 'Publizon' }
        >, shelfmark: { postfix: string | null, shelfmark: string } | null, workYear: { year: number | null } | null, catalogueCodes: { nationalBibliography: Array<string>, otherCatalogues: Array<string> } } } } | null };

export type ManifestationBasicDetailsFragment = { pid: string, abstract: Array<string>, ownerWork: { workId: string }, titles: { full: Array<string> }, materialTypes: Array<{ materialTypeSpecific: { display: string } }>, creators: Array<
    | { display: string }
    | { display: string }
  >, edition: { publicationYear: { display: string } | null } | null, series: Array<{ title: string, members: Array<{ numberInSeries: string | null, work: { workId: string } }> }>, languages: { main: Array<{ display: string, iso639Set1: string }> | null } | null };
...
export type GetManifestationViaMaterialByFaustQuery = { manifestation: { pid: string, abstract: Array<string>, ownerWork: { workId: string }, titles: { full: Array<string> }, materialTypes: Array<{ materialTypeSpecific: { display: string } }>, creators: Array<
      | { display: string }
      | { display: string }
    >, edition: { publicationYear: { display: string } | null } | null, series: Array<{ title: string, members: Array<{ numberInSeries: string | null, work: { workId: string } }> }>, languages: { main: Array<{ display: string, iso639Set1: string }> | null } | null } | null };
...
export type GetManifestationViaBestRepresentationByFaustQuery = { manifestation: { ownerWork: { manifestations: { bestRepresentation: { pid: string, abstract: Array<string>, ownerWork: { workId: string }, titles: { full: Array<string> }, materialTypes: Array<{ materialTypeSpecific: { display: string } }>, creators: Array<
            | { display: string }
            | { display: string }
          >, edition: { publicationYear: { display: string } | null } | null, series: Array<{ title: string, members: Array<{ numberInSeries: string | null, work: { workId: string } }> }>, languages: { main: Array<{ display: string, iso639Set1: string }> | null } | null } } } } | null };
...
export type GetMaterialQuery = { work: { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, materialTypes: Array<{ materialTypeGeneral: { code: GeneralMaterialTypeCodeEnum }, materialTypeSpecific: { display: string } }>, mainLanguages: Array<{ display: string, iso639Set1: string }>, subjects: { all: Array<
        | { display: string }
        | { display: string }
        | { display: string }
        | { display: string }
      ...
      >, dbcVerified: Array<
        ...
        | { display: string }
        | { display: string }
      > }, fictionNonfiction: { display: string, code: FictionNonfictionCodeEnum } | null, dk5MainEntry: { display: string, code: string } | null, relations: { hasReview: Array<{ pid: string }>, hasAdaptation: Array<{ ownerWork: { workId: string, workTypes: Array<WorkTypeEnum>, titles: { main: Array<string> } } }> }, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
      | { __typename: 'Corporation', display: string }
      | { __typename: 'Person', display: string }
    >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
            | { display: string }
...
export type GetMaterialGloballyQuery = { work: { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, materialTypes: Array<{ materialTypeGeneral: { code: GeneralMaterialTypeCodeEnum }, materialTypeSpecific: { display: string } }>, mainLanguages: Array<{ display: string, iso639Set1: string }>, subjects: { all: Array<
        | { display: string }
        | { display: string }
        | { display: string }
        | { display: string }
...
export type GetInfomediaQuery = { infomedia: { error: InfomediaErrorEnum | null, article: { byLine: string | null, dateLine: string | null, headLine: string | null, hedLine: string | null, paper: string | null, text: string | null } | null } };

export type GetReviewManifestationsQueryVariables = Exact<{
  pid: Array<string> | string;
}>;


export type GetReviewManifestationsQuery = { manifestations: Array<{ pid: string, recordCreationDate: string, creators: Array<
      | { display: string }
      | { display: string }
    >, access: Array<
      ...
      | { __typename: 'InterLibraryLoan' }
      | { __typename: 'Publizon' }
    >, edition: { publicationYear: { display: string } | null } | null, hostPublication: { title: string, issue: string | null } | null, physicalDescription: { summaryFull: string | null } | null, dateFirstEdition: { display: string } | null, workYear: { display: string } | null, review: { rating: string | null, reviewByLibrarians: Array<{ content: string | null, heading: string | null, type: ReviewElementTypeEnum | null, manifestations: Array<{ pid: string, titles: { main: Array<string> } } | null> | null } | null> | null } | null } | null> };
...
export type OpenOrderMutation = { submitOrder: { status: SubmitOrderStatusEnum, message: string | null, orderId: string | null } | null };
...
export type RecommendFromFaustQuery = { recommend: { result: Array<{ work: { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
          | { __typename: 'Corporation', display: string }
          | { __typename: 'Person', display: string }
        >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
                | { display: string }
            ...
            >, contents: Array<{ heading: string, type: ContentsEntityEnum, raw: string | null, entries: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, creators: { persons: Array<{ display: string, firstName: string | null, lastName: string | null, attributeToName: string | null }> | null, corporations: Array<{ display: string, main: string | null }> | null } | null, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string }, sublevel: Array<{ contributors: Array<string> | null, playingTime: string | null, title: { display: string } }> | null }> | null }> | null }> | null, edition: { summary: string, publicationYear: { display: string } | null } | null, dateFirstEdition: { display: string, year: number | null } | null, audience: { generalAudience: Array<string>, ages: Array<{ display: string }>, childrenOrAdults: Array<{ display: string, code: ChildOrAdultCodeEnum }> } | null, notes: Array<{ display: Array<string> }>, languages: { notes: Array<string> | null, main: Array<{ display: string, iso639Set1: string }> | null } | null, physicalDescription: { summaryFull: string | null, numberOfPages: number | null } | null, hostPublication: { summary: string } | null, accessTypes: Array<{ code: AccessTypeCodeEnum }>, access: Array<
              ...
              | { __typename: 'InterLibraryLoan', loanIsPossible: boolean }
              | { __typename: 'Publizon' }
            >, shelfmark: { postfix: string | null, shelfmark: string } | null, workYear: { year: number | null } | null, catalogueCodes: { nationalBibliography: Array<string>, otherCatalogues: Array<string> } } } } }> } };
...
export type SearchFacetQuery = { search: { facets: Array<{ name: string, type: FacetFieldEnum, values: Array<{ key: string, term: string, score: number | null, traceId: string }> }> } };
...
export type SearchWithPaginationQuery = { search: { hitcount: number, works: Array<{ workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
        | { __typename: 'Corporation', display: string }
        | { __typename: 'Person', display: string }
      >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
              | { display: string }
...
export type ComplexSearchWithPaginationWorkAccessQuery = { complexSearch: { hitcount: number, works: Array<{ workId: string, manifestations: { all: Array<{ pid: string, identifiers: Array<{ type: IdentifierTypeEnum, value: string }>, access: Array<
...
export type ComplexSearchWithPaginationQueryVariables = Exact<{
  ...
  limit: unknown;
  filters: ComplexSearchFiltersInput;
  sort?: Array<SortInput> | SortInput | null | undefined;
}>;


export type ComplexSearchWithPaginationQuery = { complexSearch: { hitcount: number, works: Array<{ workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
        | { __typename: 'Corporation', display: string }
        | { __typename: 'Person', display: string }
      >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
              | { display: string }
...
export type SuggestionsFromQueryStringQuery = { localSuggest: { result: Array<{ type: SuggestionTypeEnum, term: string, work: { workId: string, titles: { main: Array<string> }, creators: Array<
          | { display: string }
          | { display: string }
        >, manifestations: { all: Array<{ pid: string }>, bestRepresentation: { pid: string, languages: { main: Array<{ display: string, iso639Set1: string }> | null } | null } } } | null }> } };

export type GetCoversByPidsQueryVariables = Exact<{
  pids: Array<string> | string;
}>;


export type GetCoversByPidsQuery = { manifestations: Array<{ pid: string, cover: { xSmall: { url: string | null, width: number | null, height: number | null } | null, small: { url: string | null, width: number | null, height: number | null } | null, medium: { url: string | null, width: number | null, height: number | null } | null, large: { url: string | null, width: number | null, height: number | null } | null } } | null> };
...
export type GetBestRepresentationPidByIsbnQuery = { complexSearch: { works: Array<{ workId: string, manifestations: { bestRepresentation: { pid: string } } }> } };
...
export type IntelligentFacetsQuery = { search: { intelligentFacets: Array<{ name: string, type: FacetFieldEnum, values: Array<{ key: string, term: string, score: number | null, traceId: string }> }> } };
...
export type WorkRecommendationsQuery = { recommend: { result: Array<{ work: { workId: string, titles: { main: Array<string> }, creators: Array<
          | { display: string }
          | { display: string }
        > } }> } };
...
export type PlaceCopyMutation = { elba: { placeCopyRequest: { status: CopyRequestStatusEnum } } };

export type ManifestationsSimpleFragment = { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
        | { display: string }
        | { display: string }
        | { display: string }
        | { display: string }
...
export type ManifestationsAccessFragment = { all: Array<{ pid: string, identifiers: Array<{ type: IdentifierTypeEnum, value: string }>, access: Array<
      | { __typename: 'AccessUrl', origin: string, url: string, loginRequired: boolean }
      | { __typename: 'DigitalArticleService', issn: string }
      | { __typename: 'Ereol', origin: string, url: string, canAlwaysBeLoaned: boolean }
      | { __typename: 'InfomediaService', id: string }
...
export type ManifestationsSimpleFieldsFragment = { pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
      | { display: string }
      | { display: string }
      | { display: string }
      | { display: string }
...
export type ManifestationReviewFieldsFragment = { pid: string, recordCreationDate: string, creators: Array<
    | { display: string }
    | { display: string }
  >, access: Array<
    | { __typename: 'AccessUrl', url: string, origin: string }
    ...
    | { __typename: 'InterLibraryLoan' }
    | { __typename: 'Publizon' }
  >, edition: { publicationYear: { display: string } | null } | null, hostPublication: { title: string, issue: string | null } | null, physicalDescription: { summaryFull: string | null } | null, dateFirstEdition: { display: string } | null, workYear: { display: string } | null, review: { rating: string | null, reviewByLibrarians: Array<{ content: string | null, heading: string | null, type: ReviewElementTypeEnum | null, manifestations: Array<{ pid: string, titles: { main: Array<string> } } | null> | null } | null> | null } | null };

export type SeriesSimpleFragment = { title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> };

export type WorkAccessFragment = { workId: string, manifestations: { all: Array<{ pid: string, identifiers: Array<{ type: IdentifierTypeEnum, value: string }>, access: Array<
        | { __typename: 'AccessUrl', origin: string, url: string, loginRequired: boolean }
        | { __typename: 'DigitalArticleService', issn: string }
        | { __typename: 'Ereol', origin: string, url: string, canAlwaysBeLoaned: boolean }
        | { __typename: 'InfomediaService', id: string }
...
export type WorkSmallFragment = { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, titles: { full: Array<string>, original: Array<string> | null }, creators: Array<
    | { __typename: 'Corporation', display: string }
    | { __typename: 'Person', display: string }
  >, series: Array<{ title: string, isPopular: boolean | null, readThisFirst: boolean | null, readThisWhenever: boolean | null, members: Array<{ numberInSeries: string | null, work: { workId: string, titles: { main: Array<string> } } }> }>, workYear: { year: number | null } | null, manifestations: { all: Array<{ pid: string, genreAndForm: Array<string>, source: Array<string>, publisher: Array<string>, subjects: { all: Array<
          | { display: string }
...
export type WorkMediumFragment = { workId: string, abstract: Array<string> | null, genreAndForm: Array<string>, materialTypes: Array<{ materialTypeGeneral: { code: GeneralMaterialTypeCodeEnum }, materialTypeSpecific: { display: string } }>, mainLanguages: Array<{ display: string, iso639Set1: string }>, subjects: { all: Array<
      | { display: string }
      | { display: string }
      | { display: string }
      | { display: string }
...
export type WithLanguagesFragment = { languages: { main: Array<{ display: string, iso639Set1: string }> | null } | null };
...
export const useComplexFacetSearchQuery = <
    ...
    return useQuery<ComplexFacetSearchQuery, TError, TData>(
      ...
      fetcher<ComplexFacetSearchQuery, ComplexFacetSearchQueryVariables>(ComplexFacetSearchDocument, variables),
      options
    )};
...
export const useComplexSuggestQuery = <
    ...
    return useQuery<ComplexSuggestQuery, TError, TData>(
      ...
      fetcher<ComplexSuggestQuery, ComplexSuggestQueryVariables>(ComplexSuggestDocument, variables),
      options
    )};
...
export const useGetCoversByPidsQuery = <
    ...
    return useQuery<GetCoversByPidsQuery, TError, TData>(
      ...
      fetcher<GetCoversByPidsQuery, GetCoversByPidsQueryVariables>(GetCoversByPidsDocument, variables),
      options
    )};
...
export const useGetBestRepresentationPidByIsbnQuery = <
    ...
    return useQuery<GetBestRepresentationPidByIsbnQuery, TError, TData>(
      ...
      fetcher<GetBestRepresentationPidByIsbnQuery, GetBestRepresentationPidByIsbnQueryVariables>(GetBestRepresentationPidByIsbnDocument, variables),
      options
    )};
