...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getDeleteReservationsMutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getAddReservationsDeprecatedMutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateReservationsMutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getAddReservationsV2MutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getCreateV9MutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getCreateWithGuardianMutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getRenewLoansV2MutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateV4MutationOptions(options));
};
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateV8MutationOptions(options));
};
