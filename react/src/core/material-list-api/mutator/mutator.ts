...
export const mutator = async <ResponseType>(
  ...
  return undefined as ResponseType; // QUESTION: This cast seems very dangerous, but is suggested by Claude as a way to avoid type errors in the client generated by Orval 🤔.
};
