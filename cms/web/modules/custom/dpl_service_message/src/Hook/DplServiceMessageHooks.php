...
class DplServiceMessageHooks {
   ...
   * sits behind its own permission. This form is the whole of the gate:
   * service messages are written here and nowhere else - the bundle is out
   * of every API, import and feed the site has.
   *
   * @param array<mixed> $form
   *   The form element.
   */
