...
class DashboardBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    $data = [
      ...
      'dashboard-recommendations-heading-text' => $this->t('Inspiration for you', [], ['context' => 'Dashboard']),
      'dashboard-recommendations-loan-heading-text' => $this->t('Because you borrowed @title…', [], ['context' => 'Dashboard']),
      'dashboard-recommendations-reservation-heading-text' => $this->t('Because you reserved @title…', [], ['context' => 'Dashboard']),
      'dashboard-recommendations-favorite-heading-text' => $this->t('Because you have @title on your favorites list', [], ['context' => 'Dashboard']),
